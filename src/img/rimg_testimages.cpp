...
namespace rlf {
   ...
   namespace rimg_math {
      ...
      void rimginterface::rampx( tImgPlanar& img, size_t start, size_t end_ ) {
         auto mbegin = img.begin();
      ...
      void rimginterface::rampy( tImgPlanar& img, size_t start, size_t end_ ) {
         auto mbegin = img.begin();
      ...
      void rimginterface::rampxy( tImgPlanar& img, size_t start, size_t end_ ) {
         auto mbegin = img.begin();
